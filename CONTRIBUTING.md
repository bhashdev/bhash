Contributing to BHash Core
============================

The BHash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BHash Core project, and is not to be
confused with overall BHash Network Protocol consensus changes.

Whether a pull request is merged into BHash Core rests with the project merge
...
Patches that change BHash consensus rules are considerably more involved than
...
Where a patch set proposes to change the BHash consensus, it must have been
...
The project leader is the release manager for each BHash Core release.
