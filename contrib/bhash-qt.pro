...
RESOURCES += src/qt/bhash.qrc src/qt/bhash_locale.qrc

TRANSLATIONS += src/qt/locale/bhash_bg.ts \
                src/qt/locale/bhash_de.ts \
                src/qt/locale/bhash_en.ts \
                src/qt/locale/bhash_es.ts \
                src/qt/locale/bhash_fi.ts \
                src/qt/locale/bhash_fr.ts \
                src/qt/locale/bhash_it.ts \
                src/qt/locale/bhash_ja.ts \
                src/qt/locale/bhash_pl.ts \
                src/qt/locale/bhash_pt.ts \
                src/qt/locale/bhash_ru.ts \
                src/qt/locale/bhash_sk.ts \
                src/qt/locale/bhash_sv.ts \
                src/qt/locale/bhash_vi.ts \
                src/qt/locale/bhash_zh_CN.ts \
                src/qt/locale/bhash_zh_TW.ts
