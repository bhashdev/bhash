...
//! Number of keys to generate on default.
static const unsigned int STARTING_KEY_POOL_SIZE = 100; // [hetus] may need to increase, was 1000
...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT1000IFMN = 3,
    ONLY_NONDENOMINATED_NOT1000IFMN = 4, // ONLY_NONDENOMINATED and not 2000 HASH at the same time
...
public:
    ...
    /// Get 2000 HASH output and keys which can be used for the Masternode
