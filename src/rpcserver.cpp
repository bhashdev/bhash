...
static const CRPCCommand vRPCCommands[] =
	...
	{"util", "makekeypair", &makekeypair, true, false, false},
        ...
        /* BHash features */
        {"bhash", "masternode", &masternode, true, true, false},
        {"bhash", "listmasternodes", &listmasternodes, true, true, false},
        {"bhash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bhash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bhash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bhash", "masternodedebug", &masternodedebug, true, true, false},
        {"bhash", "startmasternode", &startmasternode, true, true, false},
        {"bhash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bhash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bhash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bhash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bhash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bhash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bhash", "mnbudget", &mnbudget, true, true, false},
        {"bhash", "preparebudget", &preparebudget, true, true, false},
        {"bhash", "submitbudget", &submitbudget, true, true, false},
        {"bhash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bhash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bhash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bhash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bhash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bhash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bhash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bhash", "checkbudgets", &checkbudgets, true, true, false},
        {"bhash", "mnsync", &mnsync, true, true, false},
        {"bhash", "spork", &spork, true, true, false},
        {"bhash", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bhash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (Params().RequireRPCPassword() 
        && (mapArgs["-rpcpassword"] == "" || mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) {
        unsigned char rand_pwd[32];
        GetRandBytes(rand_pwd, 32);
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bhashd, or the -server option to bhash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bhash-cli " + methodname + " " + args + "\n";
}
