...
/** Utility functions used by the BHash Qt UI.
 */
namespace GUIUtil
{
...
// Render BHash addresses in monospace font
...
// Parse "bhash:" URI into recipient object, return true on successful parsing
