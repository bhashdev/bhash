                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BHash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BHash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bhash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BHash Core"), this);
    aboutAction->setStatusTip(tr("Show information about BHash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BHash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BHash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BHash addresses"));
    ...
    openAction->setStatusTip(tr("Open a BHash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BHash Core help message to get a list with possible BHash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BHash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BHash network", "", count));
}
...
{
    QString strTitle = tr("BHash Core"); // default title
