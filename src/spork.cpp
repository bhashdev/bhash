...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_15_NEW_PROTOCOL_ENFORCEMENT) r = SPORK_15_NEW_PROTOCOL_ENFORCEMENT_DEFAULT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_15_NEW_PROTOCOL_ENFORCEMENT) return "SPORK_15_NEW_PROTOCOL_ENFORCEMENT";
