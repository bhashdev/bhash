...
In order to support loading of multiple wallets in bhash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bhash.cpp.
...
Changes to bhash.cpp
----------------------
bhash.cpp is the entry point into bhash-qt, and as such, will require some minor modifications to provide hooks for
