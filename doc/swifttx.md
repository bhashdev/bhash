...
This mechanism has been integrated into Bitcore-Node-BHash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BHash-Project/insight-api-bhash#web-socket-api](https://github.com/BHash-Project/insight-api-bhash#web-socket-api) 
* API: [https://github.com/BHash-Project/insight-api-bhash#swifttx-transactions](https://github.com/BHash-Project/insight-api-bhash#swifttx-transactions) 
...
By default, the BHash Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BHash Core daemon:
